...
class O2StartEvent(Event):
    ...
    def __init__(
        ...
        timestamp_col: str = rename_helper("OXYGEN_THERAPY_STATE_START"),
        **kwargs,
    ) -> None:
...
class O2EndEvent(Event):
    ...
    def __init__(
        ...
        state: State = State.O2,
        timestamp_col: str = rename_helper("OXYGEN_THERAPY_STATE_END"),
        **kwargs,
    ) -> None:
...
class HFNOStartEvent(Event):
    ...
    def __init__(
        ...
        timestamp_col: str = rename_helper("HFNO_STATE_START"),
        **kwargs,
    ) -> None:
...
class HFNOEndEvent(Event):
    ...
    def __init__(
        ...
        label: str = "hfno_end",
        state: State = State.HFNO,
        timestamp_col: str = rename_helper("HFNO_STATE_END"),
        **kwargs,
    ) -> None:
...
class NIVStartEvent(Event):
    ...
    def __init__(
        ...
        timestamp_col: str = rename_helper("NIV_STATE_START"),
        **kwargs,
    ) -> None:
...
class NIVEndEvent(Event):
    ...
    def __init__(
        ...
        label: str = "niv_end",
        state: State = State.NIV,
        timestamp_col: str = rename_helper("NIV_STATE_END"),
        **kwargs,
    ) -> None:
...
class IntubationStartEvent(Event):
    ...
    def __init__(
        ...
        timestamp_col: str = rename_helper("INTUBATION_STATE_START"),
        **kwargs,
    ) -> None:
...
class IntubationEndEvent(Event):
    ...
    def __init__(
        ...
        state: State = State.Intubated,
        timestamp_col: str = rename_helper("INTUBATION_STATE_END"),
        **kwargs,
    ) -> None:
...
class PostHFNOStartEvent(Event):
    ...
    def __init__(
        ...
        start: bool = True,
        state: State = State.HFNO,
        timestamp_col: str = rename_helper("POST_HFNO_STATE_START"),
        **kwargs,
    ) -> None:
...
class PostHFNOEndEvent(Event):
    ...
    def __init__(
        ...
        state: State = State.HFNO,
        timestamp_col: str = rename_helper("POST_HFNO_STATE_END"),
        **kwargs,
    ) -> None:
